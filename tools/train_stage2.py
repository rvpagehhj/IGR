...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Train a one-stage detector')
    parser.add_argument(
        '--config',
        default='/home/sys123/yh/workspace/configs/config.py')
    parser.add_argument(
        '--work_dir',
        default='work_dirs/best')
    parser.add_argument('--load_from', default='/home/sys123/yh/workspace/checkpoints/12_13_multi.pth')
