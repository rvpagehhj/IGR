...
__C.TRAIN.FG_FRACTION = 0.5 #0.5 #0.25
...
# overlap in [LO, HI))
__C.TRAIN.BG_THRESH_HI = 0.5 #0.3 #0.5
__C.TRAIN.BG_THRESH_LO = 0.0 #-9999.0 #0.0
...
__C.TRAIN.SNAPSHOT_ITERS = 120000 #20000
...
# regressor
__C.MODEL.CLS_AGNOSTIC_BBOX_REG = True #False
...
__C.SOLVER.WARM_UP_FACTOR = 1.0 / 10.0 #3.0
